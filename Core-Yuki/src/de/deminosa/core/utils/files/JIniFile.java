 ...
 *
 */
public class JIniFile extends ArrayList<Object> {
  /**
	 * 
	 */
	private static final long serialVersionUID = 2368786814343241916L;
private File userFileName;
   ...
   *
   */
  public ArrayList<String> getSectionValues(String Section) {
   ...
   *
   */
  public ArrayList<String> getSection(String Section) {
    String s;
    ArrayList<String> myList = new ArrayList<String>();
    int start = this.SectionPosition(Section)+1;
    if (this.SectionPosition(Section) > -1) {
...
public boolean existValue(String Section, String key) {
...
private int valuePosition(String Section, String key) {
  ...
  private void addToList(String Section, String key, String value) {
    if (this.existSection((Section))) {
      if (this.existValue(Section, key)) {
